...
thead th {{
  ...
  padding: 3mm 2.5mm; text-align: right; vertical-align: middle;
...
tbody td {{
  padding: 3mm 2.5mm; vertical-align: top; text-align: right;
  border: 1px solid #D9E3EA;
}}
/* عرض الأعمدة الأربعة */
col.c-spec   {{ width: 16%; }}
col.c-level  {{ width: 11%; }}
col.c-reason {{ width: 40%; }}
col.c-raise  {{ width: 33%; }}
</style>
</head>
<body>
