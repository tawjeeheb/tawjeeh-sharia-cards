...
# ── الملاحظات الخمس — مهنة قاضي (نسخة متوازنة) ─────────────────────────────
# مستندة إلى: نظام القضاء، اللوائح التنظيمية، طبيعة العمل، فروق المسارات المهنية.
# لا افتراض إعلانات أو مفاضلات. ليست شرحًا نظاميًا جافًا.
NOTES = [
    # الفرق بين مسارات القضاء والنيابة وديوان المظالم — مهم لخريجي الشريعة
    "السلك القضائي وديوان المظالم والنيابة العامة مسارات عدلية مستقلة هيكليًا وتنظيميًا؛ "
    "الالتحاق بأحدها لا يفتح الباب تلقائيًا للآخر، وكل مسار له شروط دخول وسُلّم ترقي مختلف "
    "يجب دراسته منفردًا قبل اتخاذ قرار التقديم.",

    # التخصص القضائي الناشئ — المحاكم التجارية
    "إنشاء المحاكم التجارية المستقلة عام 1441هـ أفرز دوائر قضائية متخصصة في منازعات الأعمال "
    "لم تكن موجودة في بنية المحاكم العامة؛ هذا التخصص يعني أن القاضي قد يُسند إليه ملف تجاري "
    "متخصص من بداية مساره، لا بعد سنوات من الممارسة العامة.",

    # قيد شرعي جوهري يجهله خريجو القانون
    "نظام القضاء يشترط الكفاءة الفقهية الشرعية كشرط جوهري، لا مجرد شهادة أكاديمية؛ "
    "هذا يجعل خريج الحقوق أو القانون المدني بدون تأهيل شرعي كافٍ خارج نطاق السلك القضائي، "
    "وهو قيد لا يسري على معظم الوظائف القانونية الحكومية الأخرى.",

    # طبيعة الملازمة — غير مفهومة لدى أغلب المتقدمين
    "الملازمة القضائية مرحلة تشغيلية إلزامية يمر بها القاضي بعد التعيين، "
    "إذ يعمل تحت إشراف مباشر قبل أن تُسند إليه قضايا منفردًا؛ "
    "هذا يعني أن المهنة لها منحنى تأهيل رسمي داخلي يمتد بعد التعيين، لا ينتهي بالحصول على الوظيفة.",

    # أثر الدراسات العليا على مسار الإسناد — مبني على طبيعة الهيكل القضائي
    "القضاة الحاملون لدرجة الماجستير أو الدكتوراه في الفقه أو القانون المقارن يُسندون غالبًا "
    "لدوائر متخصصة أو جهات بحثية قضائية بحكم هيكل المجلس الأعلى للقضاء؛ "
    "الشهادة العليا في هذه المهنة ليست مجرد رفع للمؤهل بل مسار وظيفي مختلف داخل السلك.",
]
