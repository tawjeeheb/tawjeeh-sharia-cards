...
# ── الملاحظات الخمس — مهنة قاضي ────────────────────────────────────────────
# كل ملاحظة: سطران مفضلًا، ثلاثة حد أعلى.
# كل ملاحظة تجيب على سؤال عملي غير بديهي.
NOTES = [
    # ما القيد النظامي الذي يجهله أغلب الخريجين؟
    "الالتحاق بالسلك القضائي لا يتم بالتقديم المباشر عبر جدارات كما في الوظائف الحكومية العادية؛ "
    "القبول يمر عبر إعلانات <a href=\"https://www.moj.gov.sa\">وزارة العدل</a> المرتبطة بالمجلس الأعلى للقضاء، "
    "وتشمل اختبارات تحريرية وشفهية تقيس الكفاءة الشرعية والقانونية قبل الملازمة القضائية.",

    # ما الفرق بين المسار القضائي وغيره من المسارات العدلية؟
    "العمل في النيابة العامة أو ديوان المظالم لا يُعدّ تلقائيًا خبرة قضائية معترفًا بها عند التقديم للسلك القضائي؛ "
    "كل مسار عدلي له تسلسل هرمي مستقل وشروط ترقية مختلفة، ولا يمكن الانتقال بينها دون قرار إداري مستقل.",

    # ما الذي يميز المقبولين فعليًا؟
    "الإعلانات تُفضّل عمليًا من أتم برامج تأهيل قضائي متخصصة أو برامج الدراسات العليا في الفقه والقضاء، "
    "رغم أن نظام القضاء يكتفي بالبكالوريوس كحد أدنى؛ "
    "الفجوة بين الاشتراط النظامي ومعايير المفاضلة الفعلية أوسع مما يظهر في نص الإعلان.",

    # ما الخبرة أو الإعداد الذي يعطي أفضلية واقعية؟
    "التخصص في القضايا التجارية أصبح ذا وزن أعلى بعد استقلالية المحاكم التجارية عام 1441هـ؛ "
    "القاضي الذي تدرّب في بيئة تجارية أو شارك في تسوية منازعات قبل التعيين يُعطى أولوية في الإسناد لهذه الدوائر.",

    # ما الخطأ الشائع في فهم المهنة؟
    "كثير من الخريجين يفترضون أن شهادة الشريعة وحدها كافية للقبول في القضاء، "
    "غير أن اشتراط السيرة الحسنة والكشف الأمني والفحص الطبي وعدم الإدانة بأي حكم سابق "
    "تُستبعد بسببها نسبة من المتقدمين المستوفين للمتطلبات الأكاديمية.",
]
