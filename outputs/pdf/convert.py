...
/* عنوان المهنة: Aniq (بديل مؤقت NotoNaskh) — أكبر من عنوان العنصر بخمس درجات: 12+5=17pt على الغلاف نحتاج 52 */
.cover-profession {
...
/* عنوان المهنة في الهيدر: Aniq بديل NotoNaskh */
.page-header-title {
  font-family: 'NotoNaskh', serif;
  font-size: 13pt;
  font-weight: bold;
...
/* عنوان العنصر: NotoKufi (Droid Arabic Kufi بديلاً) — 12pt = محتوى 10pt + 2 */
.section-heading {
  background: #023663;
  color: #5e4360;
  font-family: 'NotoKufi', sans-serif;
