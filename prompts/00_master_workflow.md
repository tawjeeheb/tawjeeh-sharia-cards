...
**قاعدة تشغيلية إلزامية — لا استثناء ولا تجاوز.**
...
* stop hook أو أي رسالة نظامية داخلية
* انتهاء التقرير
* نجاح العمل
* جاهزية الملفات
* عبارة "بانتظار موافقتك"
* أي طلب مراجعة أو فحص أو تقرير

**إذا لم توجد عبارة إذن صريحة:**
...
* الرابط الصحيح في النوع الخطأ = رابط مرفوض (LINK TYPE BOUNDARY LOCK v1.0).

### LINK TYPE BOUNDARY LOCK v1.0 — الطبقة الثانية:
| القسم | الأنواع المقبولة |
|---|---|
| برامج التأهيل المعتمدة | `program`, `diploma`, `degree` فقط |
| الشهادات المهنية الاحترافية | `certification` فقط |
| الدورات الداعمة | `course` من Coursera/إثرائي/دروب فقط |

HIGH_VERIFIED وحده لا يكفي للإدراج — يجب مطابقة النوع والقسم.
